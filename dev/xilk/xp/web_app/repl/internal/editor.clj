...
(comment
  (println (add-to-routes {:app.routes/path "src/portfolio_2022/app/routes.clj"
...
(comment
  (println (add-to-strings {:app.strings/path "src/portfolio_2022/app/strings.clj"
                            :module.api/libspec :ADDED-LIBSPEC
...
(comment
  (println (add-to-stylesheets {:app.stylesheets/path "src/portfolio_2022/app/stylesheets.clj"
                                :module.api/libspec :ADDED-LIBSPEC
...
(comment
  (println (add-to-module-api
            {:module.api/path "src/portfolio_2022/home/module_api.clj"

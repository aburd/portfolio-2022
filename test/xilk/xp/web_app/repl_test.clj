...
(deftest comp-def__with-required-params__returns-shared-comp-def
  (is (= {:def/type :comp
          :module/kw :app.comps
          :module/path "src/portfolio_2022/app/comps"
          :module.api/path "src/portfolio_2022/app/comps/module_api.clj"
          :unit/kw :cmp
          :unit/libspec ['portfolio-2022.app.comps.cmp-comp :as 'cmp-comp]
          :unit/path "src/portfolio_2022/app/comps/cmp_comp.clj"
          :unit/src
          "(ns portfolio-2022.app.comps.cmp-comp\n  \"Cmp component.\"\n  (:require\n   [garden.units :refer [px]]\n   [xilk.xp.web-app.ui :as x]))\n\n(defn cmp [props]\n  (x/html\n   [:div {:class ::container}\n    [:p (::cmp props)]\n    [:p (::FIXME props)]]))\n\n(def css\n  (x/css\n   [::container {:border [[(px 2) :solid]]}]))\n\n(def strings\n  {::cmp \"Cmp\"\n   ::FIXME \"FIXME\"})\n"
...
(deftest comp-def__with-parent-module-kw__returns-comp-def
  (is (= {:def/type :comp
          :module/kw :mod-1
          :module/path "src/portfolio_2022/mod_1"
          :module.api/path "src/portfolio_2022/mod_1/module_api.clj"
          :unit/kw :cmp
          :unit/libspec ['portfolio-2022.mod-1.cmp-comp :as 'cmp-comp]
          :unit/path "src/portfolio_2022/mod_1/cmp_comp.clj"
          :unit/src
          "(ns portfolio-2022.mod-1.cmp-comp\n  \"Cmp component.\"\n  (:require\n   [garden.units :refer [px]]\n   [xilk.xp.web-app.ui :as x]))\n\n(defn cmp [props]\n  (x/html\n   [:div {:class ::container}\n    [:p (::cmp props)]\n    [:p (::FIXME props)]]))\n\n(def css\n  (x/css\n   [::container {:border [[(px 2) :solid]]}]))\n\n(def strings\n  {::cmp \"Cmp\"\n   ::FIXME \"FIXME\"})\n"
          :unit/strings-sym 'cmp-comp/strings
          :unit/css-sym 'cmp-comp/css
          :unit/template-fn basic-comp/create-data}
         (sut/comp-def {:kw               :cmp
...
(deftest comp-def__2-ary__with-no-unit-defs-in-module-def__returns-updated-module-def
  (is (= {:def/type :module
          ...
          [{:def/type :comp
            :module/kw :mod
            :module/path "src/portfolio_2022/mod"
            :module.api/path "src/portfolio_2022/mod/module_api.clj"
            :unit/kw :cmp
            :unit/libspec ['portfolio-2022.mod.cmp-comp :as 'cmp-comp]
            :unit/path "src/portfolio_2022/mod/cmp_comp.clj"
            :unit/src
            "(ns portfolio-2022.mod.cmp-comp\n  \"Cmp component.\"\n  (:require\n   [garden.units :refer [px]]\n   [xilk.xp.web-app.ui :as x]))\n\n(defn cmp [props]\n  (x/html\n   [:div {:class ::container}\n    [:p (::cmp props)]\n    [:p (::FIXME props)]]))\n\n(def css\n  (x/css\n   [::container {:border [[(px 2) :solid]]}]))\n\n(def strings\n  {::cmp \"Cmp\"\n   ::FIXME \"FIXME\"})\n"
            :unit/strings-sym 'cmp-comp/strings
            :unit/css-sym 'cmp-comp/css
            :unit/template-fn basic-comp/create-data}]}
...
(deftest module-def__with-required-params__returns-wip-module-def
  (is (= {:def/type :module
          :module/kw :dashboard
          :app.module/kw :app
          :module/path "src/portfolio_2022/dashboard"
          :wip? true}
...
(deftest module-def__with-children__returns-module-def
  (is (= {:def/type :module
          :module/kw :about
          :app.module/kw :app
          :app.stylesheets/path "src/portfolio_2022/app/stylesheets.clj"
          :app.strings/path "src/portfolio_2022/app/strings.clj"
          :app.routes/path "src/portfolio_2022/app/routes.clj"
          :module/path "src/portfolio_2022/about"
          :module.api/libspec '[portfolio-2022.about.module-api :as about]
          :module.api/path "src/portfolio_2022/about/module_api.clj"
          :module.api/routes-sym 'about/routes
          :module.api/strings-sym 'about/strings
          :module.api/css-sym 'about/css
          :module.api/src
          "(ns portfolio-2022.about.module-api\n  \"The API that app infrastructure uses to integrate this module.\n  NOTE: Xilk Web App REPL tools automatically update this file.\")\n\n(def routes\n  nil)\n\n(def css\n  (str\n   nil))\n\n(def strings\n  (merge\n   nil))\n"
...
(deftest screen-def__with-required-params__returns-screen-def
  (is (= {:def/type :screen
          ...
          :module.api/path "src/portfolio_2022/mod/module_api.clj"
          :theme/kw :default
          :theme/path "src/portfolio_2022/app/default_theme/theme.clj"
          :unit/kw :scr
          :unit/libspec ['portfolio-2022.mod.scr-screen :as 'scr-screen]
          :unit/path "src/portfolio_2022/mod/scr_screen.clj"
          :unit/route ["/mod/scr" {:name :mod/scr
                                   :get 'scr-screen/get-handler}]
          :unit.route/methods [:get]
          :unit.route/path "/mod/scr"
          :unit/src
          "(ns portfolio-2022.mod.scr-screen\n  \"Scr screen view and controller.\"\n  (:require\n   [portfolio-2022.app.default-theme.theme :as theme]\n   [garden.units :refer [px]]\n   [xilk.xp.web-app.ui :as x]))\n\n;;;; View\n\n(defn html [props]\n  (x/html\n   [:h1 {:class ::heading}\n        (::scr props)]\n   [:p (::FIXME props)]))\n\n(def css\n  (x/css\n   [::heading {:border [[(px 2) :solid]]}]))\n\n(def strings\n  {::scr-title \"Scr\"\n   ::scr \"Scr\"\n   ::FIXME \"FIXME\"})\n\n;;;; Controller\n\n(defn get-handler [req]\n  (-> {:content-fn html\n       :props {:screen.html.head.title/str-kw ::scr-title}\n       :req req}\n      theme/screen-resp))\n"
...
(deftest screen-def__with-theme-kw__returns-screen-def
  (is (= {:def/type :screen
          ...
          :module.api/path "src/portfolio_2022/mod/module_api.clj"
          :theme/kw :casual
          :theme/path "src/portfolio_2022/app/casual_theme/theme.clj"
          :unit/kw :scr
          :unit/libspec ['portfolio-2022.mod.scr-screen :as 'scr-screen]
          :unit/path "src/portfolio_2022/mod/scr_screen.clj"
          :unit/route ["/mod/scr" {:name :mod/scr
          ...
          :unit.route/path "/mod/scr"
          :unit/src
          "(ns portfolio-2022.mod.scr-screen\n  \"Scr screen view and controller.\"\n  (:require\n   [portfolio-2022.app.casual-theme.theme :as theme]\n   [garden.units :refer [px]]\n   [xilk.xp.web-app.ui :as x]))\n\n;;;; View\n\n(defn html [props]\n  (x/html\n   [:h1 {:class ::heading}\n        (::scr props)]\n   [:p (::FIXME props)]))\n\n(def css\n  (x/css\n   [::heading {:border [[(px 2) :solid]]}]))\n\n(def strings\n  {::scr-title \"Scr\"\n   ::scr \"Scr\"\n   ::FIXME \"FIXME\"})\n\n;;;; Controller\n\n(defn get-handler [req]\n  (-> {:content-fn html\n       :props {:screen.html.head.title/str-kw ::scr-title}\n       :req req}\n      theme/screen-resp))\n"
          :unit/strings-sym 'scr-screen/strings
          :unit/css-sym 'scr-screen/css
          :unit/template-fn basic-screen/create-data}
         (sut/screen-def {:kw               :scr
